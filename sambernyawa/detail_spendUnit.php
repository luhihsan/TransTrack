...
$query = "SELECT u.nomer_lambung, d.nama_driver, s.desember
          FROM unit u
          INNER JOIN driver d ON u.id_unit = d.id_unit
          INNER JOIN spend_unit s ON u.id_unit = s.id_unit
          ORDER BY s.desember $sortOrder";
}else{
          $query = "SELECT u.nomer_lambung, d.nama_driver, s.desember
          FROM unit u
          INNER JOIN driver d ON u.id_unit = d.id_unit
