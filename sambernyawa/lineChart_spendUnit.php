...
<div class="tabel">
    <div class="dropdown">
        <select id="unitDropdownSpend" onchange="updateChart()">
            <?php
            $groupCount = ceil(count($unit_spend) / 5);
            for ($i = 1; $i <= $groupCount; $i++) {
                $start = ($i - 1) * 5 + 1;
                $end = min($i * 5, count($unit_spend));
    ...
    <script>
        ...
        function updateChart() {
            var dropdown = document.getElementById('unitDropdownSpend');
